...
<div id="wrapper">
    ...
    <div class="left side-menu">
        ...
        <div class="slimscroll-menu" id="remove-scroll">
            ...
            <div class="user-box">
                <div class="user-img">
                    <img src="{{url('img/img5.jpg')}}" alt="user-img" title="Hi I am Masum" class="rounded-circle img-fluid">
                </div>
                @auth()
                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li><a href="{{'/view-product-list'}}">View-Product</a></li>
                        </ul>
                    </li>
...
<!-- Left Sidebar End -->
    ...
    <div class="content-page">
                ...
                <ul class="list-unstyled topbar-right-menu float-right mb-0">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button"
                           aria-haspopup="false" aria-expanded="false">
                            @auth()
                            <img src="{{url('assets/images/users/avatar-1.jpg')}}" alt="user" class="rounded-circle"> <span class="ml-1">{{ Auth::user()->name}}<i class="mdi mdi-chevron-down"></i> </span>
                            @endauth
                        </a>
                    ...
                    <li>
                        <div class="page-title-box">
                            <a class="navbar-brand" href="{{ url('/') }}">
                                ...
                                <img height="40px" src="{{ asset('img/icom.jpg') }}" >
                                <span class="text-success">LOVE ISLAM</span>
                            </a>
                        </div>
                    </li>
       ...
       @yield('content')
        ...
        <footer class="footer">
            <span class="text-center">2018 © Highdmin. - Coderthemes.com</span>
        </footer>
